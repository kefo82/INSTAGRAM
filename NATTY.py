...
B='\033[94m'
N = '\x1b[0m' # WARNA MATI
USN="Mozilla/5.0 (Linux; Android 11; RMX3201 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36 Instagram 215.0.0.27.359 Android (30/11; 320dpi; 720x1448; realme; RMX3201; RMX3201; mt6765; en_GB; 337202351)"
...
[00] Instagram Exit 
	...
	def ua_ran(self):
		...
		rn='Instagram {}.0.0.{}.{} Android ({}/{}; 320dpi; 720x1448; Samsung; SM-G986U; SM-G986U; mt6765; en_GB; 337202351)'.format(self.anc,self.apc,self.abc,self.xyz,self.Android_Version(andro),ponid)
